...
import { Heroanime } from '../../assets/Data'
function Navbar() {
            ...
            <div className="Serach__Login">
                <div className="search_menu">
                    <div className="inner_serach">
                        ...
                        <form action="#">
                            <input type="search" placeholder='Search' onChange={Showsearch}/>
                        </form>
                        <div className="Searchitems_bootm">
                            {
                               Heroanime.map((item)=>{
                                if(inputvalue!== ""){
                                    ...
                                    else if(item.name.toLocaleLowerCase().trim().includes(inputvalue.toLocaleLowerCase().trim())){
                                        return(
                                            <a href="#">
                                                <div className="animeSearch_menu">
